    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                String queryCats = "SELECT categoryid, categoryName FROM productcategory"; 
                PreparedStatement pstCats = con.prepareStatement(queryCats);
                ResultSet rsCats = pstCats.executeQuery();
                while (rsCats.next()) {
                    Cats catObj = new Cats();
                    catObj.setCategoryid(rsCats.getInt("categoryid"));
                    catObj.setCategoryName(rsCats.getString("categoryName"));
                    cats.add(catObj);
                }
            } catch (Exception e) {
                ...
                <div class="content container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form form id="addCategoryForm" action="SubmitProductServlet" method="post" enctype="multipart/form-data">
