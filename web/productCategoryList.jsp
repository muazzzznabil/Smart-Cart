                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    try {
                                                        ...
                                                        String query = "SELECT jc.categoryid, jc.categoryName, jc.creationDate, jc.lastModifiedDate, "
                                                                + "createdByUser.fullname AS createdByFullName, lastModifiedByUser.fullname AS lastModifiedByFullName "
                                                                + "FROM productcategory jc "
                                                                + "LEFT JOIN users createdByUser ON jc.createdBy = createdByUser.userid "
                                                                + "LEFT JOIN users lastModifiedByUser ON jc.lastModifiedBy = lastModifiedByUser.userid";
                                                    ...
                                                    <td class="text-right">
                                                        <div class="dropdown dropdown-action"> 
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right"> 
                                                                <a class="dropdown-item" href="productCategoryEdit.jsp?categoryid=<%= categoryid%>">
                                                                    <i class="fas fa-pencil-alt m-r-5"></i> Edit
                                                                </a> 
                                                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_asset" data-id="<%= categoryid%>">
