<%-- 
    Document   : dashboard
    Created on : 4 May 2024, 03:36:31
    Author     : nomieeew
--%>
...
<%
    // Check if session attribute "fullname" is null or empty
                    ...
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            ...
                            <li class="submenu"> <a href="#"><i class="fas fa-key"></i> <span> Purchases </span> <span class="menu-arrow"></span></a>
                                <ul class="submenu_class" style="display: none;">
                                    <li><a href="purchaseList.jsp">Purchase List</a></li>                                </ul>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col-sm-12 mt-5">
                                <h3 class="page-title mt-3">Good Morning <%= session.getAttribute("fullname")%>!</h3> 
                                <ul class="breadcrumb">
