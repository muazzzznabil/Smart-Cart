                ...
                <div class="content container-fluid">
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="page-title mt-5">Add Product Category</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="addCategoryForm" action="SubmitProdCat.jsp" method="post">
                                ...
                                <button type="button" class="btn btn-primary buttonedit" id="submitBtn">Add Product Category</button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Are you sure you want to add this product category?
                        </div>
